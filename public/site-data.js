  ...
  order: {
    ...
    options: [
      ...
      },
      {
        id: 'website',
        name: '개인 웹사이트 제작',
        desc: '개인 포트폴리오용 감각적인 웹사이트를 제작해드립니다. (도메인 1년마다 갱신 필요.)',
        price: '100,000원'
      },
      {
        id: 'video',
        name: '포트폴리오 영상제작',
        desc: '기존 연기영상 편집 + 포트폴리오용 영상 · 영화제작 (1분 이내 / 협의).',
        price: '200,000원'
      },
      {
        id: 'shoot-light',
        name: 'D-C 라이트 (프로필 촬영)',
        desc: '스튜디오 촬영 · 프로필 사진 촬영 · 보정본 3장 · 원본 제공 · 1컨셉 / 1착장 · 프로필 영상 짧은 클립 포함',
        price: '249,000원'
      },
      {
        id: 'shoot-basic',
        name: 'D-C 베이직 (프로필 촬영)',
        desc: '스튜디오 · 프로필 사진 · 보정본 4장 · 원본 제공 · 2컨셉/2착장 · 전신 촬영 · 프로필 영상 · 연기연습용 짧은 영상 1종',
        price: '329,000원'
      },
      {
        id: 'shoot-sig',
        name: 'D-C 시그니처 (프로필 촬영)',
        desc: '스튜디오 · 프로필 사진 · 보정본 6장 · 원본 제공 · 2~3컨셉/2착장 이상 · 전신 촬영 · 프로필 영상 · 연기연습영상 촬영/제작 포함',
        price: '429,000원'
      }
    ],
    shootingPackages: []
